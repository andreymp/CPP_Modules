...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/15 18:58:37 by jobject           #+#    #+#             */
/*   Updated: 2021/12/17 13:52:41 by jobject          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap :: takeDamage(unsigned int	amount) {
	if (energy <= amount) {
		std :: cout << "ClapTrap: " << name << ": Oh, no... I recieved " << amount << " points of damage, but I had "
